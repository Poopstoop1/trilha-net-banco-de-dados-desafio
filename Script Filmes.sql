...
Select Ano, Count(*) 'Quantidade de Filmes no ano' from Filmes group by Ano order by Sum(Duracao) Desc 
...
G.Genero 
from Filmes as F
join FilmesGenero on FilmesGenero.IdFilme = F.Id
...
join Atores as A on A.Id = E.IdAtor
